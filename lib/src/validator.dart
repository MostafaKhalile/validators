...
/// it will loop for each rule in rules List
/// if the role is type of optional it will mark the validation process
///  for the item as optional
/// which means in case of any validation
