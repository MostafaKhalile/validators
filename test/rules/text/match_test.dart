  ...
  group(
    ...
    () {
      ...
      test(
        ...
        () {
          expect(Match('queen').isValid('queen'), isTrue);
          expect(Match('validators').isValid('validators'), isTrue);
          expect(Match('validators').isValid('validators'), isTrue);
        },
      );
      test(
        ...
        () {
          ...
          expect(
            Match('validators', caseSensitive: false).isValid('validators'),
            isTrue,
          );
          expect(
      ...
      test(
        ...
        () {
          ...
          expect(
            Match('validators').isValid('Fvalidators'),
            isFalse,
          );
          expect(
            Match('validators').isValid('Fvalidators'),
      ...
      test(
        ...
        () {
          ...
          expect(
            Match('validators', caseSensitive: false).isValid(
              'Fvalidators',
            ),
            isFalse,
          );
